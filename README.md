...
## Objective
The main objective is to perform EDA on the given dataset and draw useful conclusions about general trends in hotel bookings and how factors governing hotel bookings interact.
## Dataset
...
- days_in_waiting_list: No. of days on the waiting list.
